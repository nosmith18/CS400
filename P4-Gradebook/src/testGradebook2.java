...
// Name: Binay Singh Chawla
// Email: bchawla@wisc.edu
// Team: MA
...
public class testGradebook2 {
  ...
  private static boolean testCourse() {
    ...
    // Trying on another course just to be sure
  ...
  private static boolean testStudent() {
    ...
    // Another redundant accessor test for safety
  ...
  private static boolean addCourseTest() {
    ...
    // Check to see if size of courses and grades are equal
    ...
    // check to see if duplicate courses are being accepted
  ...
  private static boolean editGradeTest() {
    ...
    // Test with some random non-existent stuff
  ...
  private static boolean getGPATest() {
    ...
    // Add courses one by one and check gpa at each step
  ...
  private static boolean importCourseTest() {
    ...
    // Checking the imported data to see if everything is correct
  ...
  private static boolean exportGradeTest() {
    ...
    // Import all courses from the courses folder

    DataHandler.initCourses(Driver.roster);

    // Assign a random grade to given ID
  ...
  public static boolean hashmapExpansionTest() {
    ...
    // start with a small hashmap in order to force expansion
    HashTableMap<String, Integer> map = new HashTableMap<>(2);

    // add some stuff and check capacity
    try {
      map.put("a", 1);
      map.put("b", 2);
      ...
      // Check if elements are still there after expansion
      // (I did not do this for last week's gradescope submission and discovered
      // this week that my rehash had a missing line. Regret it deeply)
      // Note to self and reader: always recheck elements after moving them
      try {
        map.get("a");
  ...
  public static boolean hashmapRemoveTest() {
    ...
    // Try removing a non-existent one
    ...
    // Check if they were really removed
  ...
  /**
   * 
   * This method tests the getStudent and containsKey method in the HashTableMapAPI class
   * 
   * @return true if all test cases pass, false otherwise
   */
  private static boolean getStudentTest() {
    ...
    // check for key and if it exists, then value
    ...
    // remove a value and then try finding it
    ...
    // Try getting some random non-existent stuff
  ...
  private static boolean addCourseAPITest() {
    ...
    // Try adding valid courses to students
    ...
    // Try adding to non-existent students
  ...
  public static boolean driverGPATest() {
    ...
    // Check with a bunch of invalid inputs
    ...
    // Check if a valid input throws any error messages
    ...
    // Check if a valid message is returned after passing a non-existent ID
  ...
  public static boolean driverEditTest() {
    ...
    // Try switching the order of arguments to see if a proper error message is returned
    ...
    // Check with a valid input to see that no error messages are returned
  ...
  private static boolean driverDescriptionTest() {
    ...
    // Try accessing a non-existent course froma valid student
    ...
    // Try accessing an invalid student
